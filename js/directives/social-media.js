app.directive('appSocialMedia', function () {
    ...
    '<div flex="100" layout="column" layout-gt-md="row" layout-wrap>' +
        ...
        '<div flex="100" flex-gt-md="33">' +
            '<a class="twitter-timeline" data-height="565" href="https://twitter.com/CB1939Canarias?ref_src=twsrc%5Etfw">Tweets by CB1939Canarias</a> <script async src="https://platform.twitter.com/widgets.js" charset="utf-8"></script>' +
        '</div>' +
    '</div>';
